...
class Process:
    ...
    def fc_mix(self):
        processor = FCMix(cont_size=8, classnum=6, category=self.dataset[-1], vector_size=16,
                          tesorboard_dir='./result/Data2/fc_mix_runs/Sof_Step_Droup_1e-4')
        processor.fit(self.train, self.valid, 10000, './result/Data2/fc_mix/Sof_Step_Droup_1e-4', 1e-4, 1)
...
if __name__ == "__main__":
    feature_type = ['dis', 'cont', 'cont', 'dis', 'dis', 'cont', 'dis', 'cont', 'cont', 'dis', 'dis', 'cont', 'cont',
                    'cont', 'dis']
